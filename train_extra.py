...
from model import Extra_LSTM_CRF
from utils import *


def process_data(vocab, dataset, extra, extra_layers, lower=False):
    word_idxs, extras, label_idxs = [], [], []
    ...
    return TensorDataSet(word_idxs, extras, label_idxs)


if __name__ == '__main__':
    # init config
    model_name = 'extra_lstm_crf'
